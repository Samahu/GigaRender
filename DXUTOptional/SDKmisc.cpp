...
INT_PTR CALLBACK DisplaySwitchToREFWarningProc( HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam )
{
    switch( message )
    {
        case WM_INITDIALOG:
            ...
            WCHAR sz[512];
            swprintf_s( sz, 512,
				L"This program needs to use the Direct3D %lld reference device."
				L"This device implements the entire Direct3D %d feature set, but runs very slowly."
				L"Do you wish to continue?", lParam, lParam );
